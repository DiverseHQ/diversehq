...
const AudioPlayer: FC<Props> = ({
  ...
  return (
    <div className={clsx(`bg-p-btn overflow-hidden sm:rounded-xl`, className)}>
      <div className="flex flex-nowrap flex-col space-x-2">
        {isNew && hideDelete ? (
          <CoverImage
            isNew={false}
            // @ts-ignore
        ...
        <div className="flex w-full flex-col justify-between truncate md:px-3">
