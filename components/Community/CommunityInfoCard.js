...
import { getCommunityInfo, putJoinCommunity, putLeaveCommunity } from '../../api/community'
  ...
  return (
    ...
    <div className='relative'>
      {/* eslint-disable-next-line */}
        ...
        <div className='absolute top-20 left-3 sm:left-5 border-s-bg border-4 rounded-full'><Image width={70} height={70} className="rounded-full bg-s-bg" src={community.logoImageUrl} /> </div>
