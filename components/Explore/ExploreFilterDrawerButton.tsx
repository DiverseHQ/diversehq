...
const ExploreFilterDrawerButton = () => {
          ...
          list={[
            {
              ...
              icon: () => <MdLeaderboard className="mr-1.5 w-6 h-6" />
            },
            {
              label: 'New',
              onClick: () => {
              ...
              icon: () => <HiSparkles className="mr-1.5 w-6 h-6" />
            }
          ]}
        />
      </BottomDrawerWrapper>
...
export default ExploreFilterDrawerButton
