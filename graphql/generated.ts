...
export const ProxyActionStatusDocument = `
  ...
  proxyActionStatus(proxyActionId: $proxyActionId) {
    ...
    `;
export const useProxyActionStatusQuery = <
      TData = ProxyActionStatusQuery,
      TError = unknown
    >(
      variables: ProxyActionStatusQueryVariables,
      options?: UseQueryOptions<ProxyActionStatusQuery, TError, TData>
    ) =>
    useQuery<ProxyActionStatusQuery, TError, TData>(
      ['ProxyActionStatus', variables],
      fetchData<ProxyActionStatusQuery, ProxyActionStatusQueryVariables>(ProxyActionStatusDocument, variables),
      options
    );
export const ProxyActionDocument = `
  ...
  proxyAction(request: $request)
    ...
    `;
export const useProxyActionMutation = <
      TError = unknown,
      TContext = unknown
    >(options?: UseMutationOptions<ProxyActionMutation, TError, ProxyActionMutationVariables, TContext>) =>
    useMutation<ProxyActionMutation, TError, ProxyActionMutationVariables, TContext>(
      ['ProxyAction'],
      (variables?: ProxyActionMutationVariables) => fetchData<ProxyActionMutation, ProxyActionMutationVariables>(ProxyActionDocument, variables)(),
      options
    );
...
export const useCreateUnfollowTypedDataMutation = <
    ...
    useMutation<CreateUnfollowTypedDataMutation, TError, CreateUnfollowTypedDataMutationVariables, TContext>(
      ...
      (variables?: CreateUnfollowTypedDataMutationVariables) => fetchData<CreateUnfollowTypedDataMutation, CreateUnfollowTypedDataMutationVariables>(CreateUnfollowTypedDataDocument, variables)(),
      options
    );
